...
if unknown:
    sys.exit(f"Unknown browser: {', '.join(unknown)} (chrome, edge, brave, chromium)")
...
echo "Done. Load the extension folder as an unpacked extension and restart the browser."
